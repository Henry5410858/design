...
export async function GET(
  ...
  try {
    console.log('🔍 Template catch-all API called');
    await connectDB();
    
    const { slug } = await params;
    console.log('🔍 Slug received:', slug);
    
    // Extract the ID from the slug array
    // If the URL is /api/templates/68bad037fb4a121ba01d59d9
    // slug will be ['68bad037fb4a121ba01d59d9']
