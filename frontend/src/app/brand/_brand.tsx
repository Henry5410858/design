...
import { Image as ImageIcon, Palette, TextT, FloppyDisk, List, X } from 'phosphor-react';
  ...
  return (
    <DashboardLayout>
      ...
      <div className="flex min-h-screen">
        {/* Brand Kit Sidebar */}
        <div className={`${sidebarOpen ? 'w-64' : 'w-0'} lg:w-64 bg-white border-r border-gray-200 shadow-sm flex-shrink-0 sticky top-0 h-screen overflow-y-auto transition-all duration-300 ease-in-out z-50`}>
          <div className="p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-lg font-semibold text-gray-900">Kit de Marca</h2>
              <button
                onClick={() => setSidebarOpen(false)}
