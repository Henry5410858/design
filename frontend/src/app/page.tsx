  ...
  return (
    <DashboardLayout>
      <div className="space-y-8">
        {/* Welcome Section */}
        <motion.div 
          className="relative overflow-hidden bg-gradient-to-r from-brand-primary via-brand-secondary to-brand-accent rounded-2xl p-8 lg:p-12 text-white"
        >
          <div className="relative z-10">
            ...
            <motion.p 
              className="text-xl lg:text-2xl opacity-90 max-w-2xl leading-relaxed"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            {quickActions.map((action, index) => (
              ...
              >
                <Card
                  ...
                  shadow="lg"
                >
                  <div className="w-20 h-20 bg-gradient-to-br from-brand-primary to-brand-secondary rounded-3xl mx-auto mb-6 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
        ...
        <motion.div>
          <div className="flex items-center justify-between mb-8">
            ...
            <Button variant="secondary" size="lg" leftIcon={<FiDownload />}>
              Ver Todos
            </Button>
          </div>
                ...
                >
                  <div className="relative aspect-[4/3] bg-gradient-to-br from-gray-100 to-gray-200 overflow-hidden">
                    <div className="w-full h-full bg-gradient-to-br from-gray-200 to-gray-300 flex items-center justify-center">
                      <div className="text-center">
                        ...
                        <span className="text-gray-500 text-sm font-medium">Vista previa</span>
                      </div>
                    </div>
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end">
                      <div className="p-4 w-full">
                        <Button 
                          variant="primary" 
                          size="sm" 
                          className="w-full bg-white/20 backdrop-blur-sm hover:bg-white/30 border-white/30"
                        >
                          Editar en Canva
                        </Button>
                      </div>
                  ...
                  <div className="p-5">
                    <div className="flex items-start justify-between mb-3">
                      ...
                      {template.isPremium && (
                        <FiStar className="w-5 h-5 text-yellow-500 flex-shrink-0 ml-2" />
                      )}
                    </div>
        ...
        <motion.div>
          ...
          >
            <div className="flex items-start gap-6">
              <div className="w-16 h-16 bg-gradient-to-br from-brand-primary/10 to-brand-secondary/10 rounded-2xl flex items-center justify-center flex-shrink-0">
              ...
              <div className="flex-1">
                ...
                <div className="flex items-center gap-4">
                  <Button variant="primary" size="sm" leftIcon={<FiStar />}>
                    Aplicar Consejo
                  </Button>
        ...
        >
          <div className="bg-gradient-to-r from-blue-50 to-indigo-50 rounded-2xl p-4 text-center border border-blue-200/50">
            <div className="text-2xl font-bold text-blue-600 mb-1">98%</div>
            <div className="text-sm text-blue-700 font-medium">Satisfacción</div>
          </div>
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-4 text-center border border-green-200/50">
            <div className="text-2xl font-bold text-green-600 mb-1">24/7</div>
            <div className="text-sm text-green-700 font-medium">Soporte</div>
          </div>
          <div className="bg-gradient-to-r from-purple-50 to-pink-50 rounded-2xl p-4 text-center border border-purple-200/50">
            <div className="text-2xl font-bold text-purple-600 mb-1">500+</div>
            <div className="text-sm text-purple-700 font-medium">Templates</div>
          </div>
          <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-2xl p-4 text-center border border-orange-200/50">
            <div className="text-2xl font-bold text-orange-600 mb-1">50K+</div>
            <div className="text-sm text-orange-700 font-medium">Usuarios</div>
          </div>
        </motion.div>
      </div>
    </DashboardLayout>
