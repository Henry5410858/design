...
export default function BadgesEditor({ id }: BadgesEditorProps) {
  const [canvasSize, setCanvasSize] = useState('600x600'); // Badge size
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-6">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Editor de Badges</h1>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Herramientas para Badges</h3>
            
            {/* Canvas Size */}
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 mb-2">Tamaño del Badge</label>
              <select
                value={canvasSize}
          ...
          <div className="lg:col-span-3 bg-white rounded-2xl shadow-lg p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Canvas del Badge</h3>
            ...
            <div className="flex justify-center">
              <div
                ...
                style={{
                  width: getCurrentCanvasSize().width / 2,
                  height: getCurrentCanvasSize().height / 2,
                ...
                {objects.length === 0 && (
                  <div className="absolute inset-0 flex items-center justify-center text-gray-400">
                    <div className="text-center">
                      ...
                      <p className="text-lg font-medium">¡Comienza a crear tu badge!</p>
