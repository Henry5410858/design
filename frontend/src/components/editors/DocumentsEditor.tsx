      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            <h3 className="text-lg font-semibold text-gray-900 mb-4">Herramientas para Documentos</h3>
            
            {/* Canvas Size */}
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 mb-2">Tamaño del Documento</label>
              <select
                value={canvasSize}
          ...
          <div className="lg:col-span-3 bg-white rounded-2xl shadow-lg p-6">
            ...
            <div className="flex justify-center">
              <div
                ...
                style={{
                  width: getCurrentCanvasSize().width / 4,
                  height: getCurrentCanvasSize().height / 4,
