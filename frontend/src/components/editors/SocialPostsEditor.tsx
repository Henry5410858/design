...
export default function SocialPostsEditor({ id }: SocialPostsEditorProps) {
  const [canvasSize, setCanvasSize] = useState('1080x1080'); // Instagram square
  ...
  const canvasSizes = [
    { value: '1080x1080', label: 'Instagram Square (1080×1080)', width: 1080, height: 1080 },
    { value: '1200x630', label: 'Facebook Post (1200×630)', width: 1200, height: 630 },
    { value: '1080x1350', label: 'Instagram Portrait (1080×1350)', width: 1080, height: 1350 }
  ];
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="bg-white rounded-2xl shadow-lg p-6">
            ...
            {/* Canvas Size */}
            <div className="mb-6">
              <label className="block text-sm font-medium text-gray-700 mb-2">Tamaño del Canvas</label>
              <select
                value={canvasSize}
                ...
                {objects.length === 0 && (
                  <div className="absolute inset-0 flex items-center justify-center text-gray-400">
                    <div className="text-center">
                      ...
                      <p className="text-lg font-medium">¡Comienza a crear tu post!</p>
